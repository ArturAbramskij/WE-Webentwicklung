...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-8">
                ...
                <table class="table table-hover">
                    ...
                    <?php if (isset($mitglieder)): foreach ($mitglieder as $item): ?>
                        <tr>
                            ...
                            <td class="text-right">
                                <button name="edit_btn" type="submit" class="btn btn-link" value="<?php echo $item['id']?>"><i class="fa fa-edit"></i></button>
                                <button name="delete_btn" type="submit" class="btn btn-link" value="<?php echo $item['id']?>"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
            ...
            <form action="<?php echo base_url() ?>/create_user" method="post">
